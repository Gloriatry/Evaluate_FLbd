...
class KMeans_Torch(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        # logger.info(f'cluster_assignments: {cluster_assignments}')
...
class ValidationProcessor:
    ...
    #             logger.info(f'outlier_prediction: {outlier_prediction}')
    ...
    def fed_validation(self, num_of_clusters, num_of_classes, names, evaluations_of_clusters, count_of_class_for_validator):
        ...
        # if self.params['save_validation_tensor']:
    ...
    def run(self):
        ...
        self.adversarial_num = validation_container['adversarial_num']
        ...
        if mal_val_type == 'adaptive':
            evaluations_of_clusters = self.adaptive_malicious_val_crafting(evaluations_of_clusters, count_of_class_for_validator, num_of_clusters, num_of_classes, names, 0.1)
